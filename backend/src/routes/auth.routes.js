...
import { login, register, checkRole, resetPassword, sendOTP, refreshToken, logout, updateProfileController, changePasswordController } from '../controllers/auth.controller.js';
